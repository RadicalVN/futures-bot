...
class CustomSMAStrategy(BaseStrategy):
    ...
    PARAMETERS_SCHEMA: dict = {
        ...
        "properties": {
            ...
            "len_c": {
                "type": "integer",
                "title": "Signal Smoothing Length",
                "description": "Chu ky lam muot duong trung binh tong hop",
                "default": 200,
                "minimum": 10,
                "maximum": 1000,
                "ui:widget": "number",
            ...
            "factor": {
                "type": "number",
                "title": "Trend Factor",
                "description": "He so loc nhieu khi xac dinh dao chieu xu huong",
                "default": 0.05,
                "minimum": 0.001,
                "maximum": 0.5,
                "ui:widget": "number",
            ...
            "bb_length": {
                "type": "integer",
                "title": "Basis MA Length",
                "description": "Chu ky SMA co so (dung cho momentum)",
                "default": 50,
                "minimum": 5,
                "maximum": 500,
                "ui:widget": "number",
            ...
            "bb_mult": {
                "type": "number",
                "title": "BB Multiplier",
                "description": "He so nhan do lech chuan Bollinger Bands",
                "default": 2.0,
                "minimum": 0.5,
                "maximum": 5.0,
                "ui:widget": "number",
            ...
            "momentum_n": {
                "type": "integer",
                "title": "Momentum N Periods",
                "description": "Buoc nhay n phien de tinh gia toc dai han",
                "default": 3,
                "minimum": 1,
                "maximum": 20,
                "ui:widget": "number",
            ...
            "min_slope_pct": {
                "type": "number",
                "title": "Min Slope (%)",
                "description": "Nguong do doc toi thieu de vao lenh (0 = tat loc)",
                "default": 0.0,
                "minimum": 0.0,
                "maximum": 1.0,
                "ui:widget": "number",
            ...
            "min_momentum_pct": {
                "type": "number",
                "title": "Min Momentum (%)",
                "description": "Nguong gia toc toi thieu de vao lenh (0 = tat loc)",
                "default": 0.0,
                "minimum": 0.0,
                "maximum": 1.0,
                "ui:widget": "number",
